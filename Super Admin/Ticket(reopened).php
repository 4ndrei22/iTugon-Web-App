...
<html lang="en">
  <head>
    ...
    <!-- JS Files -->
    <script src="../JS Files/goto msg/msg(reopen).js"></script>
    <!--   Core JS Files   -->
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top" Style="background-color: #671e1e;">
        ...
        <div class="container">
          ...
          <div class="box-type" onclick="msgOpenFunction();">
