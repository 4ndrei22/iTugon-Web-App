...
<html lang="en">
  <head>
    ...
    <!-- JS Files -->
    <script src="../JS Files/goto msg(staff)/Staffmsg(closed).js"></script>
  ...
  <div class="sidebar" data-color="white" data-active-color="danger">
    ...
    <div class="main-panel">
        ...
        <div class="container">
          ...
          <div class="box-type" onclick="msgClosedFunction();">
                <div class="card-block">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      <h3 class="box-status"><span class="status blk"></span>
                        Closed &nbsp; &nbsp;
